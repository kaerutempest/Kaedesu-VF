...
const SERVERS = [
  ...
  { name: 'Server Vidsrc.me (Alternative - Anti Block)', url: 'https://vidsrc.me/embed/anime' },
    ...
    >
      ...
      <div className="max-w-7xl w-full mx-auto px-0 md:px-6 py-0 md:py-6 grid grid-cols-1 lg:grid-cols-3 gap-6 relative z-20 flex-grow">
        ...
        <div className="lg:col-span-2 flex flex-col gap-4">
          ...
          <div className="mx-4 md:mx-0 flex flex-col sm:flex-row gap-3">
            <a
              href={streamUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="flex-1 flex items-center justify-center gap-2 px-5 py-3.5 bg-brand hover:bg-brand/95 text-white text-xs font-black uppercase tracking-wider rounded-xl shadow-lg shadow-brand/20 transition-all duration-200 active:scale-[0.98]"
            >
              <ExternalLink size={14} />
              <span>Buka di Tab Baru (Lewati Blokir / Fullscreen)</span>
            </a>
            ...
            <button
              ...
              className="flex items-center justify-center gap-2 px-5 py-3.5 bg-white/5 hover:bg-white/10 text-white/80 hover:text-white text-xs font-black uppercase tracking-wider rounded-xl border border-white/10 transition-all duration-200 active:scale-[0.98]"
            >
          ...
          {/* Stream Diagnostic & Troubleshooting Panel */}
          <div className="mx-4 md:mx-0 bg-neutral-900/50 border border-white/5 rounded-2xl p-5 flex flex-col gap-3.5">
            <div className="flex items-center gap-2 text-xs font-extrabold text-white/80 uppercase tracking-wider border-b border-white/5 pb-2">
              <Info size={14} className="text-brand animate-pulse" />
              <span>Analisis Mendalam & Solusi Streaming</span>
            </div>
            
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-[11px] leading-relaxed text-white/60">
              <div className="flex flex-col gap-1.5 bg-black/20 p-3 rounded-xl border border-white/5">
                <h5 className="font-bold text-white/95 flex items-center gap-1.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-brand"></span>
                  1. Kenapa Layar Rusak / Abu-abu / Blank?
                </h5>
                <p>
                  Beberapa provider internet (seperti Telkomsel/Indihome) memblokir domain stream pihak ketiga seperti <span className="text-brand">vidsrc.to</span> secara sepihak. Solusinya, gunakan tombol <strong>Buka di Tab Baru</strong> di atas atau pasang VPN / Cloudflare 1.1.1.1 untuk membuka blokir.
                </p>
              </div>
              <div className="flex flex-col gap-1.5 bg-black/20 p-3 rounded-xl border border-white/5">
                <h5 className="font-bold text-white/95 flex items-center gap-1.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-brand"></span>
                  2. Muncul Error "404" atau "File Not Found"?
                </h5>
                <p>
                  Ini berarti episode tersebut belum diunggah oleh server eksternal, atau anime ini belum ditayangkan secara resmi di TV Jepang (misalnya anime pra-rilis/upcoming seperti <strong>Youjo Senki II</strong>). Silakan ganti ke server cadangan lainnya.
                </p>
              </div>
              <div className="flex flex-col gap-1.5 bg-black/20 p-3 rounded-xl border border-white/5">
                <h5 className="font-bold text-white/95 flex items-center gap-1.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-brand"></span>
                  3. Solusi Tercepat & Terampuh
                </h5>
                <p>
                  Gunakan browser <strong>Brave Browser</strong> atau instal adblocker di browser Anda. Klik tombol <strong>Buka di Tab Baru</strong>, selesaikan verifikasi Cloudflare jika diminta, lalu video dapat diputar dengan lancar.
                </p>
              </div>
              <div className="flex flex-col gap-1.5 bg-black/20 p-3 rounded-xl border border-white/5">
                <h5 className="font-bold text-white/95 flex items-center gap-1.5">
                  <span className="w-1.5 h-1.5 rounded-full bg-brand"></span>
                  4. Gunakan Mode Otakudesu
                </h5>
                <p>
                  Jika server Jikan/Vidsrc bermasalah, Anda bisa mengaktifkan <strong>Mode Otakudesu</strong> di menu samping (kiri atas) untuk mendapatkan tautan nonton berbahasa Indonesia langsung dari server lokal Indonesia!
                </p>
              </div>
            </div>
          </div>
